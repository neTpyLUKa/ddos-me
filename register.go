...
func main() {
	if len(os.Args) < 3 {
		log.Fatal("Contract or job address was not specified")
	}
	...
	privateKey, err := crypto.HexToECDSA("c0d7245a3b9a1bd93f5730c8242c18a9271d5673631ca39b3cc9f30e146543de")
	if err != nil {
		log.Fatal(err)
	}
	...
	tx, err := contract.Register(auth, common.HexToAddress(os.Args[2]))
	if err != nil {
		log.Fatal(err)
	}
